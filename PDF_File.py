...
class PDF_File():
    ...
    def PDFtoImage(input_pdf_path):
        ...
        images = convert_from_path(input_pdf_path, 300, poppler_path = r"C:\path\to\poppler-22.12.0\Library\bin")
        for image in images:
    ...
    def Image_to_text(filename, tesseract = r'C:\Program Files\Tesseract-OCR\tesseract.exe'):
