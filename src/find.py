    ...
    def Find_name(text):
        ...
        try:
            ...
            if ak - an > 15:
                ...
                adres = str(list[an + 1]).replace('.', '').replace(',', '').replace(':', '').replace('=', '').replace('?', '').replace('!', '').replace('|', '').replace('"', '').replace('>', '').replace('<', '')
                for i in range(an + 2, ak):
                    adres += '_' + str(list[i]).replace('.', '').replace(',', '').replace(':', '').replace('=', '').replace('?', '').replace('!', '').replace('|', '').replace('"', '').replace('>', '').replace('<', '')
                #    print(adres)
